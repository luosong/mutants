...
/***/ function(module, exports, __webpack_require__) {
	...
	var PluginGeoPage = function (_BasePage) {
	    _inherits(PluginGeoPage, _BasePage);

	    function PluginGeoPage() {
	        var _ref;

	        var _temp, _this, _ret;

	        _classCallCheck(this, PluginGeoPage);

	        for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
	            args[_key] = arguments[_key];
	        }

	        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = PluginGeoPage.__proto__ || Object.getPrototypeOf(PluginGeoPage)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
	        ...
	        }, _this.onGetLocation = function () {

	            mutants.plugin.geo.getLocation(_this.getLocationCallback);
	        }, _this.getLocationCallback = function (rs) {
	        ...
	        }, _this.onShowLocation = function () {

	            var params = {
	                title: '查看位置',
	                longitude: _this.state.location.longitude,
	                latitude: _this.state.location.latitude,
	                location: _this.state.location.location,
	                city: _this.state.location.city
	            };

	            mutants.plugin.geo.showLocation(params);
	        }, _this.onDisplayNearby = function () {
	            var params = {
	                longitude: _this.state.location.longitude,
	                latitude: _this.state.location.latitude,
	                location: _this.state.location.location,
	            ...
	            mutants.plugin.geo.displayNearby(params, _this.displayNearbyCallback);
	        }, _this.displayNearbyCallback = function (rs) {
	            var resultCode = rs.resultCode;
	            var message = rs.message;
	            var body = rs.body;
	    ...
	    _createClass(PluginGeoPage, [{
	        ...
	        value: function renderContent() {
	            ...
	            var nearbyLocation = _state.nearbyLocation;
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        ...
	                        _react2.default.createElement(_Button2.default, { label: "获取当前位置", primary: true, onClick: this.onGetLocation })
	                    ),
	                    _react2.default.createElement(
	                        "div",
	                        { style: _style2.default.link },
	                        _react2.default.createElement(_Button2.default, { label: "在地图上查看", primary: true, onClick: this.onShowLocation, disabled: !this.state.getLocation })
	                    ),
	                    _react2.default.createElement(
	                        "div",
	                        { style: _style2.default.link },
	                        _react2.default.createElement(_Button2.default, { label: "查看位置周边", primary: true, onClick: this.onDisplayNearby, disabled: !this.state.getLocation })
	                    ),
	                    _react2.default.createElement(
	                        "div",
	                        { style: _style2.default.link },
	    ...
	    return PluginGeoPage;
	}(_BasePage3.default);

	exports.default = PluginGeoPage;
