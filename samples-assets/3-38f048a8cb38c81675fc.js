...
/***/ function(module, exports, __webpack_require__) {
	...
	var PluginTakePhotoPage = function (_BasePage) {
	    _inherits(PluginTakePhotoPage, _BasePage);

	    function PluginTakePhotoPage() {
	        var _ref;

	        var _temp, _this, _ret;

	        _classCallCheck(this, PluginTakePhotoPage);

	        for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
	            args[_key] = arguments[_key];
	        }

	        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = PluginTakePhotoPage.__proto__ || Object.getPrototypeOf(PluginTakePhotoPage)).call.apply(_ref, [this].concat(args))), _this), _this._requestId = 'TakePhotoInDemo', _this.state = {
	            noticeShow: false
	            ...
	            mutants.plugin.takePhoto.takePhoto(options, _this.takePhotoCallback, _this._requestId);
	        }, _this.takePhotoCallback = function (rs) {
	    ...
	    _createClass(PluginTakePhotoPage, [{
	        key: "componentWillMount",
	        value: function componentWillMount() {
	            this._initMockData();
	        }
	        ...
	        value: function renderContent() {
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(_Button2.default, { label: "点击进行拍照", primary: true, onClick: this.onClick }),
	                    _react2.default.createElement(
	                        "div",
	    ...
	    return PluginTakePhotoPage;
	}(_BasePage3.default);

	exports.default = PluginTakePhotoPage;
