...
/***/ function(module, exports, __webpack_require__) {
	...
	var PluginSpeechRecoPage = function (_BasePage) {
	    _inherits(PluginSpeechRecoPage, _BasePage);

	    function PluginSpeechRecoPage() {
	        var _ref;

	        var _temp, _this, _ret;

	        _classCallCheck(this, PluginSpeechRecoPage);

	        for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
	            args[_key] = arguments[_key];
	        }

	        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = PluginSpeechRecoPage.__proto__ || Object.getPrototypeOf(PluginSpeechRecoPage)).call.apply(_ref, [this].concat(args))), _this), _this._requestId = 'SpeechRecoInDemo', _this.state = {
	            ...
	            state: ''
	        }, _this._doing = false, _this.onClick = function () {
	            if (_this.state.doing) {
	                mutants.plugin.speechReco.stop();
	            } else {
	                mutants.plugin.speechReco.start();
	            }
	            _this.setState({
	                doing: !_this.state.doing
	            });
	    ...
	    _createClass(PluginSpeechRecoPage, [{
	        key: "componentWillMount",
	        value: function componentWillMount() {
	            this._initMockData();
	        }
	        ...
	        value: function bindEvents() {
	            ...
	            var plugin = mutants.plugin.speechReco;
	            ...
	            //在说话过程中, 动态更新识别结果
	            plugin.onUpdateResult(function (rs) {
	                _this2.setState({
	                    recoState: '动态识别结果',
	                    recoResult: rs.data
	                });
	        ...
	        value: function renderContent() {
	            ...
	            var _state = this.state;
	            var recoState = _state.recoState;
	            var recoResult = _state.recoResult;

	            var buttonLabel = this.state.doing ? '点击停止' : '点击开始';
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        "div",
	                        { style: _style2.default.link },
	                        _react2.default.createElement(_Button2.default, { label: buttonLabel, primary: true, onClick: this.onClick })
	                    )
	                ),
	    ...
	    return PluginSpeechRecoPage;
	}(_BasePage3.default);

	exports.default = PluginSpeechRecoPage;
