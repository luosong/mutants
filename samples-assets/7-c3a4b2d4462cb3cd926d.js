...
/***/ function(module, exports, __webpack_require__) {
	...
	var PluginPhonePage = function (_BasePage) {
	    _inherits(PluginPhonePage, _BasePage);

	    function PluginPhonePage() {
	        var _ref;

	        var _temp, _this, _ret;

	        _classCallCheck(this, PluginPhonePage);

	        for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
	            args[_key] = arguments[_key];
	        }

	        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = PluginPhonePage.__proto__ || Object.getPrototypeOf(PluginPhonePage)).call.apply(_ref, [this].concat(args))), _this), _this._requestId = 'PhoneInDemo', _this.state = {
	            noticeShow: false,
	            ...
	            mutants.plugin.phone.call(phoneNumber, _this.phoneCallCallback, _this._requestId);
	        }, _this.phoneCallCallback = function (rs) {
	        ...
	        value: function renderContent() {
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(_Button2.default, { label: "拨打电话", primary: true, onClick: this.onClick })
	                ),
	    ...
	    return PluginPhonePage;
	}(_BasePage3.default);

	exports.default = PluginPhonePage;
