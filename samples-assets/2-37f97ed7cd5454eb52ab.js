...
/***/ function(module, exports, __webpack_require__) {
	...
	var PluginChoosePhotoPage = function (_BasePage) {
	    _inherits(PluginChoosePhotoPage, _BasePage);

	    function PluginChoosePhotoPage() {
	        var _ref;

	        var _temp, _this, _ret;

	        _classCallCheck(this, PluginChoosePhotoPage);

	        for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
	            args[_key] = arguments[_key];
	        }

	        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = PluginChoosePhotoPage.__proto__ || Object.getPrototypeOf(PluginChoosePhotoPage)).call.apply(_ref, [this].concat(args))), _this), _this._requestId = 'ChoosePhotoInDemo', _this.state = {
	            noticeShow: false
	            ...
	            mutants.plugin.choosePhoto.choosePhoto(options, _this.choosePhotoCallback, _this._requestId);
	    ...
	    _createClass(PluginChoosePhotoPage, [{
	        ...
	        value: function _initMockData() {
	            var mockData = {
	                ChoosePhotoPlugin: {
	                    status: 'success',
	                    data: ['http://localhost:8080/assets/images/demo/1.jpg', 'http://localhost:8080/assets/images/demo/2.jpg']
	                }
	            };
	        ...
	        value: function renderContent() {
	            ...
	            var imageItems = this.images.map(function (img) {
	                return _react2.default.createElement("img", { style: _style2.default.image, src: img });
	            });
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        ...
	                        "点击下方按钮可以进入相册选择图片, demo中设置最大图片数量为9张"
	                    ),
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(_Button2.default, { label: "点击选择图片", primary: true, onClick: this.onClick }),
	                    _react2.default.createElement(
	                        "div",
	    ...
	    return PluginChoosePhotoPage;
	}(_BasePage3.default);

	exports.default = PluginChoosePhotoPage;
